...
from config import dsk,key1,key2,email,passw,aws_access_key,aws_secret_access_key,aws_storage_bucket_name
...
RAZORPAY_API_KEY=key1
RAZORPAY_API_SECRET_KEY=key2
